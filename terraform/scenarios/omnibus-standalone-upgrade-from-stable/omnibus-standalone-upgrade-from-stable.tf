...
resource "null_resource" "chef_server_config" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "curl -vo /tmp/chef-server-unstable.rpm https://packages.chef.io/files/unstable/chef-server/${var.build_version}/el/7/chef-server-core-${var.build_version}-1.el7.x86_64.rpm",
